...
v_mul_u32_u24 v[vgprOffset], 16, v[vgprIndexU]
...
buffer_load_dwordx4 v[vgprValueA+4:vgprValueA+7], v[vgprOffset], s[sgprSrcA:sgprSrcA+3], 0 offen offset:64

buffer_load_dwordx4 v[vgprValueB+0:vgprValueB+3], v[vgprOffset], s[sgprSrcB:sgprSrcB+3], 0 offen offset:0
buffer_load_dwordx4 v[vgprValueB+4:vgprValueB+7], v[vgprOffset], s[sgprSrcB:sgprSrcB+3], 0 offen offset:64
...
s_nop 7
s_nop 7
# TODO: modify to use other instruction
...
# v_mfma_f32_16x16x128_f8f6f4 acc[0:3], v[vgprValueB+0:vgprValueB+7], v[vgprValueA+0:vgprValueA+7], acc[0:3]
v_mfma_scale_f32_16x16x128_f8f6f4 acc[0:3], v[vgprValueB+0:vgprValueB+7], v[vgprValueA+0:vgprValueA+7], acc[0:3], v[vgprValueSB], v[vgprValueSA]
s_nop 7
s_nop 7
s_nop 7
s_nop 7
