...
.amdhsa_kernel Transpose
  ...
  .amdhsa_group_segment_fixed_size 1024 // lds bytes
...
s_mul_i32 s[sgprTmp], s[sgprTmp], 6 // * 6 bits / 8 bits
s_lshr_b32 s[sgprTmp], s[sgprTmp], 3
...
v_mul_u32_u24 v[vgprOffset], v[vgprOffset], 6  // * 6 bits / 8 bits
v_lshrrev_b32 v[vgprOffset], 3, v[vgprOffset]  // * 6 bits / 8 bits

buffer_load_dwordx3 v[vgprValue+0:vgprValue+2], v[vgprOffset], s[sgprSrdIn:sgprSrdIn+3], 0 offen offset:0
s_waitcnt vmcnt(0)

v_mul_u32_u24 v[vgprOffset], v[vgprSerial], 16 // read 16 element
v_mul_u32_u24 v[vgprOffset], v[vgprOffset], 8  // * 8 bits / 8 bits
v_lshrrev_b32 v[vgprOffset], 3, v[vgprOffset]  // * 8 bits / 8 bits

ds_write_b96 v[vgprOffset], v[vgprValue+0:vgprValue+2] offset:0
...
v_mul_u32_u24 v[vgprOffset], 8, v[vgprOffset]  // * 8 bits / 8 bits
v_lshrrev_b32 v[vgprOffset], 3, v[vgprOffset]  // * 8 bits / 8 bits

ds_read_b96_tr_b6 v[vgprValue+0:vgprValue+2], v[vgprOffset] offset:0
# ds_read_b96 v[vgprValue+0:vgprValue+2], v[vgprOffset] offset:0
...
v_add_u32 v[vgprOffset], v[vgprIdx0], v[vgprIdx1]
v_mul_u32_u24 v[vgprOffset], 6, v[vgprOffset]  // * 6 bits / 8 bits
v_lshrrev_b32 v[vgprOffset], 3, v[vgprOffset]  // * 6 bits / 8 bits

buffer_store_dwordx3 v[vgprValue+0:vgprValue+2], v[vgprOffset], s[sgprSrdOut:sgprSrdOut+3], 0 offen offset:0
s_waitcnt vmcnt(0)
