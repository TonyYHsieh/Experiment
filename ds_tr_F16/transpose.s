...
s_mul_i32 s[sgprTmp], s[sgprTmp], 2 // bytes
...
v_mul_u32_u24 v[vgprOffset], v[vgprSerial], 4 // element
v_mul_u32_u24 v[vgprOffset], v[vgprOffset], 2 // bytes
...
v_and_b32 v[vgprIdx0], v[vgprSerial], 3
v_and_b32 v[vgprIdx1], v[vgprSerial], 15
v_lshrrev_b32 v[vgprIdx1], 2, v[vgprIdx1]
v_lshrrev_b32 v[vgprIdx2], 4, v[vgprSerial]

v_mul_u32_u24 v[vgprIdx0], v[vgprIdx0], 4
v_mul_u32_u24 v[vgprIdx1], v[vgprIdx1], 16
v_mul_u32_u24 v[vgprIdx2], v[vgprIdx2], 4
...
ds_read_b64_tr_b16 v[vgprValue+0:vgprValue+1], v[vgprOffset] offset:0
