...
s_mul_i32 s[sgprTmp], s[sgprTmp], 6  // * 6 bits per elements
...
v_mul_u32_u24 v[vgprOffset], 6, v[vgprOffset] // * 6 bits per element
...
buffer_load_dwordx2 v[vgprValueA+4:vgprValueA+5], v[vgprOffset], s[sgprSrcA:sgprSrcA+3], 0 offen offset:16
buffer_load_dwordx4 v[vgprValueB+0:vgprValueB+3], v[vgprOffset], s[sgprSrcB:sgprSrcB+3], 0 offen offset:0
buffer_load_dwordx2 v[vgprValueB+4:vgprValueB+5], v[vgprOffset], s[sgprSrcB:sgprSrcB+3], 0 offen offset:16
...
# v_mfma_f32_16x16x128_f8f6f4 acc[0:3], v[vgprValueB+0:vgprValueB+3], v[vgprValueA+0:vgprValueA+3], acc[0:3] cbsz:2 blgp:2
v_mfma_scale_f32_16x16x128_f8f6f4 acc[0:3], v[vgprValueB+0:vgprValueB+5], v[vgprValueA+0:vgprValueA+5], acc[0:3], v[vgprValueSB], v[vgprValueSA] cbsz:2 blgp:2
s_nop 7
s_nop 7
s_nop 7
s_nop 7
